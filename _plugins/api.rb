...
module Hub
  ...
  class Api
    ...
    def self.generate_pif_projects_endpoint(site)
      projects = (site.data['pif_projects'] || [])
      generate_endpoint(site, 'pif_projects', 'PIF Projects',
        'Presidential Innovation Fellow project info', projects)
    end
